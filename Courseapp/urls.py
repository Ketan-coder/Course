...
urlpatterns: list[URLPattern] = [
    ...
    path('courses/search_by_category/<str:category>/', views.course_list, name='course_list'),
    ...
    path("student/update/status/", login_required(views.student_update_status_api), name="student_update_status"),
